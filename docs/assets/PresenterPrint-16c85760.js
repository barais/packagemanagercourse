import{d as _,u as d,a as u,c as m,b as h,r as p,o as s,e as n,f as t,t as o,g as l,F as g,h as f,n as v,i as x,j as b,k as y,l as N,m as k,_ as P}from"./index-6bae32de.js";import{N as w}from"./NoteDisplay-b3743f79.js";const V={class:"m-4"},L={class:"mb-10"},S={class:"text-4xl font-bold mt-2"},T={class:"opacity-50"},B={class:"text-lg"},D={class:"font-bold flex gap-2"},H={class:"opacity-50"},M=t("div",{class:"flex-auto"},null,-1),j={key:0,class:"border-gray-400/50 mb-8"},z=_({__name:"PresenterPrint",setup(C){d(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
